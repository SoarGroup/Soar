...
\hline
\soar{\soar{ -c, --chunks }} & Print memory usage of chunks.  \\
\hline
\soar{\soar{ -d, --default }} & Print memory usage of default productions.  \\
\hline
\soar{\soar{ -j, --justifications }} & Print memory usage of justifications.  \\
\hline
\soar{\soar{ -u, --user }} & Print memory usage of user-defined productions.  \\
\hline
\soar{\soar{production\_name}} & Print memory usage for a specific production.  \\
\hline
\emph{n}
