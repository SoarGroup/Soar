...
\hline
\soar{\soar{ -m, --memory }} & report usage for Soar's memory pools  \\
\hline
\soar{\soar{ -r, --rete }} & report statistics about the rete structure  \\
\hline
\soar{\soar{ -s, --system }} & report the system (agent) statistics. This is the default if no args are specified.  \\
\hline
\end{tabular}
