...
\hline
\soar{\soar{filename}} & The file of Soar productions and commands to load.  \\
\hline
\soar{\soar{ -a, --all }} & Enable a summary for each file sourced  \\
\hline
\soar{\soar{ -d, --disable }} & Disable all summaries  \\
\hline
\soar{\soar{ -v, --verbose }} & Print excised production names  \\
\hline
\end{tabular}
