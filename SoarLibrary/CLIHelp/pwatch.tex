...
\hline
\soar{\soar{ -d, --disable, --off }} & Turn production watching off for the specified production. If no production is specified, turn production watching off for all productions.  \\
\hline
\soar{\soar{ -e, --enable, --on }} & Turn production watching on for the specified production. The use of this flag is optional, so this is pwatch's default behavior. If no production is specified, all productions currently being watched are listed.  \\
\hline
\soar{\soar{production name}} & The name of the production to watch.  \\
\hline
\end{tabular}
