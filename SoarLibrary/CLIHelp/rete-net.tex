...
\hline
\soar{\soar{ -s, --save }} & Save the Rete net in the named file. Cannot be saved when there are justifications present. Use excise -j \\
\hline
\soar{\soar{ -l, -r, --load, --restore }} & Load the named file into the Rete network. working memory and production memory must both be empty. Use excise -a \\
\hline
\soar{\soar{filename}} & The name of the file to save or load.  \\
\hline
\end{tabular}
