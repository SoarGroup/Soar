...
\hline
\soar{\soar{\soar{ -a, --ask }}} & Ask the user to choose. Not implemented. \\
\hline
\soar{\soar{\soar{ -f, --first }}} & Select the first indifferent object from Soar's internal list.  \\
\hline
\soar{\soar{\soar{ -l, --last }}} & Select the last indifferent object from Soar's internal list.  \\
\hline
\soar{\soar{\soar{ -r, --random }}} & Select randomly (default).  \\
\hline
\end{tabular}
...
\hline
\soar{\soar{\soar{ inds }}} & indifferent-selection  \\
\hline
\end{tabular}
