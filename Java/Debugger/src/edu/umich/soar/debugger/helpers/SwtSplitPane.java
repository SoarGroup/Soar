...
public class SwtSplitPane
{
    ...
    public SwtSplitPane(Composite parent, int style)
    {
        ...
        m_Sash = new Sash(m_Pane,
                m_Orientation == SWT.VERTICAL ? SWT.HORIZONTAL : SWT.VERTICAL);
    ...
    // Instead I expose the control it represents. Gives me more control while
    // I'm learning.
    ...
    public void setControls(Control leftOrTop, Control rightOrBottom)
    {
        if (leftOrTop.getParent() != m_Pane)
            throw new IllegalArgumentException(
                    "We need the controls to be owned by this panel");
