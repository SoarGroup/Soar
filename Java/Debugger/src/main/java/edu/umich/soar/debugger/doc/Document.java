...
public class Document implements Kernel.AgentEventInterface, Kernel.SystemEventInterface
{
	...
	public static final String[] kPrevVersions = new String[] { "9_0_1", "8_6_3" } ;
	...
	public Document()
	{
		...
		Module textTrace = new Module("Text Trace Window", "Commands are entered at a prompt.  Output from the commands and trace output from runs is shown in a text window.", edu.umich.soar.debugger.modules.TextTraceView.class) ;
		Module update 	 = new Module("Auto Update Window", "The user's command is automatically executed at the end of each run.", edu.umich.soar.debugger.modules.UpdateCommandView.class) ;
		Module keep 	 = new Module("Keep Window", "Commands are entered at a prompt and the results are displayed in a scrolling text window.  Trace output from runs is not shown.", edu.umich.soar.debugger.modules.KeepCommandView.class) ;
		Module button 	 = new Module("Button Bar", "A collection of user-customizable buttons", edu.umich.soar.debugger.modules.ButtonView.class) ;
		Module phase 	 = new Module("Phase Diagram", "A view that shows Soar's phases of execution", edu.umich.soar.debugger.modules.PhaseView.class) ;
		Module edit 	 = new Module("Edit Production Window", "A window used to edit a production and then load it into Soar", edu.umich.soar.debugger.modules.EditorView.class) ;
		...
		Module rhsAccum	 = new Module("RHS Number Accumulator", "RHS function number (type: double) accumulator.", edu.umich.soar.debugger.modules.RHSNumberAccumulatorView.class);
		Module rhsText	 = new Module("RHS Text View", "Displays attribute-value pairs from RHS functions.", edu.umich.soar.debugger.modules.RHSFunTextView.class);
		Module waterfallText = new Module("RHS Waterfall Text View", "Tagged version of the accumulator.", edu.umich.soar.debugger.modules.RHSWaterfallAccumulatorView.class);
		Module objectText = new Module("RHS Object Text View", "Similar to text view for displaying multiple objects.", edu.umich.soar.debugger.modules.RHSObjectTextView.class);
		Module operatorText = new Module("RHS Operator Text View", "Similar to object text view, but works with operators and numeric indifferents.", edu.umich.soar.debugger.modules.RHSOperatorTextView.class);
		Module barChart  = new Module("RHS Bar Chart View", "Simple RHS function controlled bar chart.", edu.umich.soar.debugger.modules.RHSBarChartView.class);
