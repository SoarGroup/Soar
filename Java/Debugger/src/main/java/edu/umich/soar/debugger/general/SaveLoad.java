...
public class SaveLoad
{
     ...
     * @param fileExt
     *            The file extension to load (e.g. "xml")
     * @param fileDesc
     *            A description for this type of file (e.g. "Editor file")
     * @param props
     *            The app properties to use to store the current directory
     *            preference
     * @param fileSaveName
     *            The name of the property to use to store directory to use for
     *            saving files (e.g. "SaveFile")
     * @param fileLoadName
     *            The name of the property to use to store directory to use for
    ...
    public static String LoadFileDialog(Composite parent, String[] fileExts,
            ...
            String fileSaveName, String fileLoadName)
    {
            ...
            String fileSaveName, String fileLoadName)
    {
        ...
        // but only be writing a facade for FileDialog() and replacing the logic
        // for "open".
        // This is fine for now.
        File file = new File(filePath);
        if (file.exists())
        {
            MessageBox msg = new MessageBox(parent.getShell(), SWT.ICON_WARNING
                    | SWT.OK | SWT.CANCEL);
            msg.setText("Save As");
            msg.setMessage(filePath
    ...
    public static String SelectFolderDialog(Composite parent,
            String initialFolder, String title, String message)
    {
