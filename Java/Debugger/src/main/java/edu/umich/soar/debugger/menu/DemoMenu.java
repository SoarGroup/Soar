...
public class DemoMenu
{
    ...
    private AbstractAction m_TOH_Recursive = new AbstractAction(
            "Towers of Hanoi Recursive")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("towers-of-hanoi",
    ...
    private AbstractAction m_Waterjug_RL = new AbstractAction("Water Jug RL")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("water-jug", "water-jug-rl.soar"));
        }
    };

    private AbstractAction m_Waterjug_Lookahead = new AbstractAction(
    ...
    private AbstractAction m_Waterjug = new AbstractAction("Water Jug")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("water-jug", "water-jug.soar"));
        }
    };
    ...
    private AbstractAction m_BlocksWorld = new AbstractAction("Blocks World")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("blocks-world", "blocks-world.soar"));
        }
    };

    private AbstractAction m_BlocksWorldOpSub = new AbstractAction(
            "Blocks World Operator Subgoaling")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("blocks-world",
                    "blocks-world-operator-subgoaling.soar"));
        }
    };

    private AbstractAction m_BlocksWorldLookahead = new AbstractAction(
            "Blocks World Look-Ahead")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("blocks-world", "blocks-world-look-ahead.soar"));
        }
    };
    ...
    private AbstractAction m_EightPuzzle = new AbstractAction("Eight puzzle")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("eight-puzzle", "eight-puzzle.soar"));
        }
    };

    private AbstractAction m_FifteenPuzzle = new AbstractAction(
            "Fifteen puzzle")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("eight-puzzle", "fifteen-puzzle.soar"));
        }
    };

    private AbstractAction m_Mac = new AbstractAction(
            "Missionaries and Cannibals")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("mac", "mac.soar"));
        }
    };

    private AbstractAction m_MacPlanning = new AbstractAction(
            "Missionaries Planning")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("mac", "mac-planning.soar"));
        }
    };
    ...
    private AbstractAction m_Arithmetic = new AbstractAction("Arithmetic")
    {
        public void actionPerformed(ActionEvent e)
        {
            loadDemo(new File("arithmetic", "arithmetic.soar"));
        }
    };

    // private AbstractAction m_DemoPathItem = new
    // AbstractAction("Set the library path (contains the demos)...") { public
    // void actionPerformed(ActionEvent e) { setLibraryPath() ; } } ;

    /** Create this menu */
    public static DemoMenu createMenu(MainFrame frame, Document doc,
            String title)
    {
    ...
    /**
     * Load a specific demo. We'll make this public so that buttons etc. can
     * call here to load a demo
     */
    public void loadDemo(File filename, boolean echoCommand)
    {
        ...
        File demoPath = new File(libraryPath + File.separator + "share"
                + File.separator + "soar", "Demos");
        filePath = new File(demoPath, filename.getPath());

        String commandLine = m_Document.getSoarCommands().getSourceCommand(
                filePath.getPath());
    ...
    /*
     * private boolean setLibraryPath() { if (!m_Document.isConnected()) {
     * m_Frame.ShowMessageBox("No kernel running",
     * "Need to have Soar running before changing the library path (its stored inside the kernel)"
     * ) ; return false ; }
     * 
     * String newPath = m_Frame.getKernelMenu().setKernelLocation() ; if
     * (newPath == null) return false ;
     * 
     * // The library path is the parent of the kernel DLL (at least with our
     * current structure) File path = new File(newPath) ; String libPath =
     * path.getParent() ;
     * 
     * if (libPath == null) return false ;
     * 
     * String setLocation =
     * m_Document.getSoarCommands().setLibraryLocationCommand(libPath) ;
