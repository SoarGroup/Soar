...
public class GeneralFileFilter extends javax.swing.filechooser.FileFilter {
	...
	/**
	 * The first extension added -- if the user selects this filter use this
	 * extension if they don't provide one
	 */
	...
	/**
	 * Returns the first extension added to this filter. Use this extension if
	 * the user is saving a file and doesn't enter an extension
	 */
