...
public class XmlOutput
{
    ...
    public final static int kDecisionDigits = 6; // So colons match with print
     ...
     * so we can do rapid indenting through a lookup
     */
    ...
    /**
     * This is a class constructor -- it runs once, the first time the class is
     * used. Don't mistake it for a normal, instance constructor
     */
    static
    {
    ...
    /**
     * Returns a string of spaces of the given length (>= 0). This is an
    ...
    public static String getSpaces(int length)
    {
        ...
        // We use a lookup from a table if the length is reasonable (< 100 right
        // now)
    ...
    /**
     * Returns a string to indent to a certain stack depth (depth stored as a
     * string)
     */
    ...
    public static String getStateText(Agent agent, ClientTraceXML xmlTrace,
            int indentSize)
    {
    ...
    public static String getOperatorText(Agent agent, ClientTraceXML xmlTrace,
            int indentSize)
    {
        // 2: O: O8 (move-block)
        StringBuffer text = new StringBuffer();
     ...
     * declared-support="[:i-support|:o-support]"> <conditions>
     * <conjunctive-negation-condition> <condition test="[state|impasse]"
     * id="<s1>" condition="^foo bar ^hello <world>"></condition> ...
     * </conjunctive-negation-condition> <condition ...></condition> ...
     * </conditions> <actions> <action id="<s1>"
     * action="^foo2 bar2 ^what ever"></action> <action
     * function="some function string"></action> </actions> </production>
     */
    ...
    /*
     * <backtrace
     * prodname="evaluate-operator*elaborate*symbolic-evaluation*from-subgoal">
     * <grounds> <wme attr="desired" id="E4" tag="281" value="D1"></wme> <wme
     * attr="evaluation" id="O25" tag="282" value="E4"></wme> <wme
     * attr="evaluation" id="S8" tag="277" value="E4"></wme> <wme
     * attr="evaluation" id="O25" tag="282" value="E4"></wme> <wme attr="name"
     * id="O25" tag="270" value="evaluate-operator"></wme> <wme attr="operator"
     * id="S8" tag="276" value="O25"></wme> </grounds> <potentials></potentials>
     * <locals> <wme attr="failure" id="S9" tag="329" value="D1"></wme> <wme
     * attr="superstate" id="S9" tag="284" value="S8"></wme> </locals>
     * <negated></negated> <nots></nots> </backtrace>
     */
            ...
            String parentTagName)
    {
        ...
        if (xml.IsTagBacktrace())
        {
            ...
            if (name != null)
            {
                ...
                {
                    text
                            .append("(We already backtraced through this instantiation.)");
                    text.append(kLineSeparator);
                }
            }
            else
    ...
    public static String getPreferenceProductionText(Agent agent,
            ClientTraceXML xmlTrace)
    {
