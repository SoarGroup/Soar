...
{
    /**
     * Path to folder containing the application's data. Typically, this is the
     * same folder as the .jar file for the application
     */
    ...
    /************************************************************************
     * Finds the folder that contains the application's jar file. The method is
    ...
    public static File FindDataDirectory()
    {
        ...
        java.security.CodeSource source = edu.umich.soar.debugger.general.Debug.class
