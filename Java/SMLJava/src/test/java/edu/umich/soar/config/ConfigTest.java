...
public class ConfigTest
{
    ...
    public void setUp()
    {
        ...
        largeTestData
                .add(new ConfigTestPair("noquotesspace", "[noquotesspace]"));
        ...
        largeTestData.add(new ConfigTestPair("two_element_array",
                "[data, banks]"));
        largeTestData.add(new ConfigTestPair("two_element_array_with_trailer",
                "[data, banks]"));
        largeTestData
                .add(new ConfigTestPair("array_no_quotes", "[data, banks]"));
        largeTestData.add(new ConfigTestPair("array_spaces_no_quotes",
                "[databanks, startrek]"));
        largeTestData
                .add(new ConfigTestPair("array_spaces_no_quotes_with_trailer",
                        "[databanks, startrek]"));
        largeTestData.add(new ConfigTestPair("double_noquotes", "[1.23]"));
        largeTestData.add(new ConfigTestPair("double_quotes", "[1.23]"));
        largeTestData
                .add(new ConfigTestPair("split_across_lines", "[testing]"));
        largeTestData.add(new ConfigTestPair("array_line_split",
                "[hey, you, guys]"));
        largeTestData.add(new ConfigTestPair("array_line_split_noquotes",
                "[hey, you, guys]"));
        ...
        largeTestData.add(new ConfigTestPair("key3",
