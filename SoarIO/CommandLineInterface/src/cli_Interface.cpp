...
EXPORT bool CommandLineInterface::DoPrint(sml::Connection* pConnection, sml::ElementXML* pResponse, gSKI::IAgent* pAgent, const PrintBitset& options, int depth, const std::string* pArg) {
