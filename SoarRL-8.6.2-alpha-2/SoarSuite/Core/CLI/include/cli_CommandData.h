...
namespace cli {
	...
	enum eExciseOptions {
		...
		EXCISE_TASK,
		EXCISE_USER,
		EXCISE_TEMPLATE,	// NUMERIC_INDIFFERENCE
		EXCISE_RL,			// NUMERIC_INDIFFERENCE
	...
	enum eNumericIndifferentMode {     // NUMERIC_INDIFFERENCE
		NUMERIC_INDIFFERENT_QUERY,
		NUMERIC_INDIFFERENT_AVERAGE,
		NUMERIC_INDIFFERENT_SUM,
	};

	enum eExplorationMode {			  // NUMERIC_INDIFFERENCE
		EXPLORATION_QUERY,
	...
	enum ePrintOptions {
		...
		PRINT_STATES,
		PRINT_USER,			
		PRINT_TEMPLATE,		// NUMERIC_INDIFFERENCE
		PRINT_RL,			// NUMERIC_INDIFFERENCE
		PRINT_VARPRINT,
