...
public class EditorView extends AbstractView
{
	...
	********************************************************************************************/
	 ...
	 * @param parentPane
	 * 
	 * @see edu.umich.soar.debugger.modules.AbstractView#init(edu.umich.soar.debugger.MainFrame, edu.umich.soar.debugger.doc.Document, edu.umich.soar.debugger.manager.Pane)
	 ********************************************************************************************/
