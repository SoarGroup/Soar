...
{	
	...
	* 
	*************************************************************************/
	public abstract edu.umich.soar.debugger.general.JavaElementXML convertToXML(String tagName, boolean storeContent) ;
	...
	* 
	*************************************************************************/
	public abstract void loadFromXML(MainFrame frame, edu.umich.soar.debugger.doc.Document doc, Pane parent, edu.umich.soar.debugger.general.JavaElementXML element) throws Exception ;
