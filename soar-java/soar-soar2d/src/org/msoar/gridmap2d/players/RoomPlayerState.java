...
public class RoomPlayerState {
	...
	public double[] getFloatLocation() {
		return org.msoar.gridmap2d.Arrays.copyOf(floatLocation, floatLocation.length);
	}
	
	void setFloatLocation(double[] newFloatLocation) {
		assert newFloatLocation.length == floatLocation.length;
		floatLocation = org.msoar.gridmap2d.Arrays.copyOf(newFloatLocation, newFloatLocation.length);
	}
