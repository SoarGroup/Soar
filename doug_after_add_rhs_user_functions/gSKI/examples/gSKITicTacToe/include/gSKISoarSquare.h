...
* 
*/
class SoarSquare : public gSKI::IInputProducer 
{
public:
	...
	*/
	void Attach(gSKI::IWorkingMemory* wmemory, Marker m, int inRow, int inCol);
	...
	*/
	gSKI::IWMObject* GetSquareIdentifier();
...
private:
	...
	gSKI::IWme* squareWMEStructure;//the parent wme for the row, symbol, col
