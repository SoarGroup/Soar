### Modified 11/11/98 KJC to add "stopAfterDecision" and "runTilOutputGenerated"
###
### $Id$
###
### $Log$
...
###
### Revision 1.6  2004/07/12 15:25:41  rmarinie
### fixed bugzilla bug 392
###
  ...
  # menu .destroyAgent.m
   ...
   grid .agentcreation.color -sticky ew -padx 5
    ...
    button .agentcreation.createAgent -text "Create $ETCPConfig(AgentName)" \
       -command createNewAgent -activebackground green
