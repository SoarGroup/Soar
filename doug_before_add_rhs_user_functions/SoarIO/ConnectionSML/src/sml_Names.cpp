...
char const* const sml_Names::kSMLVersionValue	= "8.6.0" ;
char const* const sml_Names::kSoarVersionValue	= "1.0" ;
...
char const* const sml_Names::kParamLearnSetting		= "learn_setting";
