...
%2javac -source 1.4 -d tmp -classpath %SOARBIN%\swt.jar;%SOARBIN%\sml.jar;%SOARBIN%\JavaBaseEnvironment.jar -sourcepath source source\tanksoar\TankSoar.java

@echo ----------=========Jarring contents of tmp dir=========-----------
%2jar cfm JavaTankSoar.jar JarManifest -C tmp .
