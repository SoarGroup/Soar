...
bool CommandLineInterface::DoSMem( const char pOp, const std::string* pAttr, const std::string* pVal )
{
    ...
    {   // Print SMem Settings
        ...
        PrintCLIMessage_Item("recognition:", agnt->smem_params->recognition, 40);
        PrintCLIMessage_Item("recognition-representation:", agnt->smem_params->recognition_representation, 40);
        PrintCLIMessage("");
