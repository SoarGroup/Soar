...
bool CommandLineInterface::DoEpMem( const char pOp, const std::string* pAttr, const std::string* pVal, epmem_time_id memory_id )
{
    ...
    {   // Print Epmem Settings
        ...
        PrintCLIMessage_Item("recognition:", agnt->epmem_params->recognition, 40);
        PrintCLIMessage_Item("recognition-representation:", agnt->epmem_params->recognition_representation, 40);
        PrintCLIMessage_Item("recognition-merge-depth:", agnt->epmem_params->recognition_merge_depth, 40);
        PrintCLIMessage("");
