/* Auto-generated by gen_cli_help.sh on Mon Jun  6 17:24:27 EDT 2011 */
#include <map>
...
void initdocstrings() {
	...
	docstrings["run"] = 
		...
		"              specified.\n"
		"-f, forever   Run until halted by problem-solving completion or until stopped\n"
		"              by an interrupt.\n"
		...
		"defaults to '1'. The argument forever (can be shortened to f) is a keyword used\n"
		"instead of an integer count and indicates Soar should be run indefinitely,\n"
		"until halted by problem-solving completion, or stopped by an interrupt.\n"
		"\n"
		...
		"\n"
		"1run -d 5 -inteleave p` || run the\n"
		"agent one phase and then move to the\n"
		"next agent, looping over agents until\n"
		"they have run for 5 decision cycles\n"
		"                                       run the agent one decision cycle and\n"
		"                                       then move to the next agent. When an\n"
		"run -o 3 -interleave d                 agent generates output for the 3rd time,\n"
		"                                       it no longer runs even if other agents\n"
		"                                       continue.\n"
		"\n"
	...
	docstrings["smem"] = 
		...
		"-b, --print  Creates a backup of the semantic database on disk\n"
		"\n"
		"Description \n"
		"\n"
