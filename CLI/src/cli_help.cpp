...
void initdocstrings() {
	...
	docstrings["epmem"] = 
		...
		"             Linear weight of match\n"
		"balance      cardinality (1) vs. working  [0, 1]                    1\n"
		"             memory activation (0) used\n"
		"             in calculating match score\n"
		"cache-size   Number of memory pages used  1, 2, ...                 10000\n"
		"             in the SQLite cache\n"
		"             Number of episode encodings\n"
		"commit       between committing changes   1, 2, ...                 1\n"
		"             to disk\n"
		...
		"             Forces episode encoding/\n"
		"force        ignoring in the next storage ignore, remember, off     off\n"
		"             phase\n"
		...
		"             Decision cycle phase to\n"
		"phase        encode new episodes and      output, selection         output\n"
		"             process epmem link commands\n"
		"timers       Timer granularity            off, one, two, three      off\n"
		"trigger      How episode encoding is      dc, output, none          output\n"
		"             triggered\n"
		"\n"
		...
		"episodes will be encoded only if the agent made modifications to the output-\n"
		"link during that decision cycle. When set to 'dc', new episodes will\n"
		"be encoded every decision cycle.\n"
		...
		"                                 processed\n"
		"ncb-wmes  Last Retrieval WMEs    Number of WMEs added to working memory in last\n"
		"                                 reconstruction\n"
		"qry-pos   Last Query Positive    Number of leaf WMEs in the query cue of last\n"
		"                                 cue-based retrieval\n"
		"qry-neg   Last Query Negative    Number of leaf WMEs in the neg-query cue of\n"
		"                                 the last cue-based retrieval\n"
		...
		"qry-lits  Last Query Literals    Number of literals in the DNF graph of last\n"
		"                                 cue-based retrieval\n"
		"\n"
		"Timers\n"
		"\n"
		...
		"format and visualization tools, see http://www.graphviz.org .\n"
		"\n"
		"See Also\n"
		"\n"
		"watch wma\n"
	...
	docstrings["smem"] = 
		...
		"including concept activation levels. If <ltid> is omitted, the entire contents\n"
		"of the semantic store are outputted. For more information on this format and\n"
		"visualization tools, see http://www.graphviz.org .\n"
		"\n"
		"Reinitialization\n"
		"\n"
	...
	docstrings["wma"] = 
		...
		"memory activation. To get the activation of individual WMEs, use print -i.\n"
		"\n"
		"Parameters\n"
		"\n"
		"The wma command uses the --get|--set <parameter> <value> convention rather than\n"
		"individual switches for each parameter. Running smem without any switches\n"
		...
		"the exp function, as these can be expensive during runtime. The size of the\n"
		"cache is based upon two run-time parameters (decay-rate and decay-thresh), and\n"
		"one compile time parameter, WMA_REFERENCES_PER_DECISION (default value of 10),\n"
		"which estimates the maximum number of times a WME will be referenced during a\n"
		"decision. The cache is composed of double variables (i.e. 64-bits, currently)\n"
		"and the number of cache items is computed as follows:\n"
		"e^((thresh - ln(max_refs)) / decay_rate)\n"
		"With the current default parameter values, this will incur 42.65KB of memory.\n"
		"Holding the decay-rate constant, reasonable changes to decay-thresh (i.e. +/\n"
		"- 5) does not greatly change this value. However, small changes to decay-rate\n"
		"will dramatically change this profile. For instance, keeping everything else\n"
		"constant, a decay-thresh of 0.3 requires 12.9MB and 0.2 requires 16.4GB.\n"
