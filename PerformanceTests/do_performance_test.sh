...
if [ $lTestSuite == "full" ] ; then
  if [ $lVersion == "9.6" ] ; then
    ...
    nice -n -10 ./PerformanceTests water-jug-lookahead96 15 100000
    ...
    nice -n -10 ./PerformanceTests water-jug-lookahead94 15 100000
  ...
  if [ $lVersion == "9.6" ] ; then
    nice -n -10 ./PerformanceTests mac-planning96 1 300 0
    nice -n -10 ./PerformanceTests mac-planning96_learning 1 165 32
    nice -n -10 ./PerformanceTests water-jug-lookahead96 1 100000
    nice -n -10 ./PerformanceTests water-jug-lookahead96_learning 1 102 50
    nice -n -10 ./PerformanceTests arithmetic96 1
    nice -n -10 ./PerformanceTests arithmetic96_learning 1
