    ...
    class Connection
    {
        ...
        public:
            ...
            *************************************************************/
            ...
            virtual bool        IsTracingCommunications()
            {
                return m_bTraceCommunications ;
            }
            ...
            *************************************************************/
            virtual void        SetIsKernelSide(bool state)
            {
                m_bIsKernelSide = state ;
            }
            virtual bool        IsKernelSide()
            {
                return m_bIsKernelSide ;
            }
            ...
            *************************************************************/
            ...
            void SetStatus(char const* pStatus)
            {
                m_Status = pStatus ;
            }
            char const* GetAgentStatus()
            {
                return m_AgentStatus.c_str() ;
            }
            void SetAgentStatus(char const* pStatus)
            {
                m_AgentStatus = pStatus ;
            }
            ...
            *************************************************************/
            ...
            bool      HadError()
            {
                return m_ErrorCode != Error::kNoError ;
            }
            ...
            *************************************************************/
            ...
            int64_t GetInitialTimeTagCounter()
            {
                return m_InitialTimeTagCounter ;
            }
            
            double GetIncomingTime()
            {
                return m_IncomingTime.get_sec() ;
            }
            double GetOutgoingTime()
            {
                return m_OutgoingTime.get_sec() ;
            }
