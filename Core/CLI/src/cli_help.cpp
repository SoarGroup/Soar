/* Auto-generated by gen_cli_help.sh on Wed Sep 17 00:58:47 EDT 2014 */
#include <map>
...
void initdocstrings()
{
	...
	docstrings["chunk-name-format"] =
		...
		"Options \n"
		"\n"
        "-n,        Name chunks based on the order in which they were created\n"
        "--numbered\n"
        ...
        "chunk will have a name that beings with prefix followed by -multi, for example\n"
	...
	docstrings["epmem"] =
        ...
        "Timer                              Description\n"
        "| ncb_edge\n"
        "Collecting edges during\n"
        "reconstruction\n"
        "ncb_edge_rit                       Collecting edges from relational interval\n"
        "                                   tree\n"
		"ncb_node              Collecting nodes during reconstruction\n"
        "ncb_node_rit                       Collecting nodes from relational interval\n"
        "                                   tree\n"
        ...
        "query_sql_end_ep                   SQL query for the end of the range of an\n"
        "                                   edge\n"
		"query_sql_end_now     SQL query for the end of the now of an edge\n"
        "query_sql_end_point                SQL query for the end of the point of an\n"
        "                                   edge\n"
        "query_sql_start_ep                 SQL query for the start of the range of an\n"
        "                                   edge\n"
        "query_sql_start_now                SQL query for the start of the now of an\n"
        "                                   edge\n"
        "query_sql_start_point              SQL query for the start of the point of an\n"
        "                                   edge\n"
	...
	docstrings["indifferent-selection"] =
        ...
        "parameter [exploration       Get/Set exploration policy parameters (if value\n"
        "policy parameters]           not given, returns the current value)\n"
        "parameter [reduction_policy] Get/Set exploration policy parameter reduction\n"
        "(value]                      policy (if policy not given, returns the current)\n"
        "parameter reduction_policy   Get/Set exploration policy parameter reduction\n"
        "[exploration policy          rate for a policy (if rate not give, returns the\n"
        "parameter]                   current)\n"
        "-a, --auto-reduce [on,off]   Get/Set auto-reduction setting (if setting not\n"
        "(reduction-rate]             provided, returns the current)\n"
		"\n"
		"Description \n"
		"\n"
	...
	docstrings["smem"] =
        ...
        "}\n"
        "\n"
        "This would remove all attributes and values of @W34 from the semantic store.\n"
        ...
        "\n"
        "Suppose that LTI @W34 did not contain bad-attribute. The above example would\n"
    ...
    docstrings["svs"] =
        ...
        "<state>.scene.                    Prints information about a specific node\n"
        "<node-path>\n"
