/* Auto-generated by gen_cli_help.sh on Fri Nov 23 16:23:40 EST 2012 */
#include <map>
...
void initdocstrings() {
	...
	docstrings["epmem"] = 
		...
		"                                                             values\n"
		"           Linear weight of match cardinality (1) vs.\n"
		"balance    working memory activation (0) used in calculating [0, 1]     1\n"
		"           match score\n"
		"database   Database storage method                           file,      memory\n"
		"                                                             memory\n"
		"exclusions Toggle the exclusion of an attribute string       any string epmem,\n"
		"           constant                                                     smem\n"
		"           Forces episode encoding/ignoring in the next      ignore,\n"
		"force      storage phase                                     remember,  off\n"
		"                                                             off\n"
		"learning   Episodic memory enabled                           on, off    off\n"
		"merge      Controls how retrievals interact with long-term   none, add  none\n"
		"           identifiers in working memory\n"
		"path       Location of database file                         empty,     empty\n"
		"                                                             some path\n"
		"phase      Decision cycle phase to encode new episodes and   output,    output\n"
		"           process epmem link commands                       selection\n"
		"                                                             dc,\n"
		"trigger    How episode encoding is triggered                 output,    output\n"
		"                                                             none\n"
		"\n"
		"Performance Parameters \n"
		"\n"
		"Parameter            Description                    Possible values Default\n"
		"cache-size           Number of memory pages used in 1, 2, ...       10000\n"
		"                     the SQLite cache\n"
		"graph-match          Graph matching enabled         on, off         on\n"
		"graph-match-ordering Ordering of identifiers during undefined, dfs, undefined\n"
		"                     graph match                    mcv\n"
		...
		"                     disk                           performance\n"
		"page-size            Size of each memory page used  1k, 2k, 4k, 8k, 8k\n"
		"                     in the SQLite cache            16k, 32k, 64k\n"
		"timers               Timer granularity              off, one, two,  off\n"
		"                                                    three\n"
		"\n"
	...
	docstrings["learn"] = 
		...
		"-E, --except            Learning is on, except as specified by RHS dont-learn\n"
		"                        actions.\n"
		...
		"                        Build chunks only for subgoals that have not yet had\n"
		"-b, --bottom-up         any subgoals with chunks built. Learning must be\n"
		"                        enabled.\n"
		"-n, --local-negations   Build chunks when local negation encountered in\n"
		"                        backtraces. (default)\n"
		"-N,                     Do not build chunks when local negation encountered in\n"
		"--no-local-negations    backtraces.\n"
		"-p,                     Add relevant desirability preferences to backtraces.\n"
		"--desirability-prefs\n"
		"-P,                     Do not add any desirability preferences to backtraces.\n"
		"--no-desirability-prefs (default)\n"
		"\n"
		"Description \n"
		"\n"
		...
		"of learning in Soar.\n"
		"\n"
		"The final six settings, --all-levels, --bottom-up, --local-negations,\n"
		"--no-local-negations, --desirability-prefs and --no-desirability-prefs, are\n"
		"orthogonal to the --on, --except, --only, and --off flags, and so, may be used\n"
	...
	docstrings["rl"] = 
		...
		"\n"
		"Parameter        Description                           Possible values  Default\n"
		"apoptosis        Automatic excising of productions via none, chunks,    none\n"
		"                 base-level decay                      rl-chunks\n"
	...
	docstrings["smem"] = 
		...
		"merge     Controls how retrievals interact with long-term    none, add  add\n"
		"          identifiers in working memory\n"
		"mirroring Controls automatic encoding of working-memory      on, off    off\n"
		"          changes\n"
		"path      Location of database file                          empty,     empty\n"
		"                                                             some path\n"
		"\n"
		...
		"activation-mode           retrievals that match more than  frequency,   recency\n"
		"                          one memory                       base-level\n"
		...
		"                          computation\n"
		"                          Sets the policy for re-computing stable,\n"
		"base-update-policy        base-level activation            naive,       stable\n"
		"                                                           incremental\n"
		"                          Sets time deltas after which\n"
		"base-incremental-threshes base-level activation is         1, 2, 3, ... 10\n"
		...
		"             SQLite cache\n"
		"lazy-commit  Delay writing semantic store changes on, off           on\n"
		"             to file until agent exits\n"
		"optimization Policy for committing data to disk   safety,           performance\n"
		"                                                  performance\n"
		"page-size    Size of each memory page used in the 1k, 2k, 4k, 8k,   8k\n"
		"             SQLite cache                         16k, 32k, 64k\n"
		"timers       Timer granularity                    off, one, two,    off\n"
		"                                                  three\n"
		"\n"
