/* Auto-generated by gen_cli_help.sh on Thu Jun 29 12:35:33 EDT 2017 */
...
void initdocstrings()
{
	...
	docstrings["print"] = 
		...
		"\n"
		"print --gds\n"
		"The Goal Dependency Set (GDS) is described in a subsection in the chapter The\n"
		"Soar Architecture in the Soar manual. This command is a debugging command for\n"
	...
	docstrings["visualize"] = 
		...
		"  system\n"
		"  visualize [ identity_graph | ebc_analysis]            Visualize EBC explainer\n"
		"  analysis\n"
		"  ------------------ Presentation -------------------\n"
		...
		"                                                        created by the Soar\n"
		"  architecture\n"
		"  color-identities                       [ on | OFF ]   Color identities in\n"
		"  visualization\n"
		"  use-joined-identities                  [ ON | off ]   Color using final\n"
		"  joined identities\n"
		"  ------------------ File Handling ------------------\n"
		"  file-name                                  soar_viz\n"
