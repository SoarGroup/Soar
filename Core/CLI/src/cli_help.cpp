/* Auto-generated by gen_cli_help.sh on Wed Oct  5 18:35:56 EDT 2016 */
#include <map>
...
void initdocstrings()
{
	...
	docstrings["chunk"] = 
		...
		"  ------------------- Settings ----------------------\n"
		"  always | NEVER | flagged | unflagged                  When Soar will learn\n"
		"  new rules\n"
		...
		"  interrupt-on-watched                   [ ON | off ]   Stop Soar after\n"
		"  learning from watched production\n"
		"  interrupt-on-failure                   [ on | OFF ]   Stop Soar after\n"
		"  learning failure\n"
		"  ----------------- EBC Mechanisms ------------------\n"
		"  add-osk                                [ on | OFF ]   Learn from operator\n"
		"  selection knowledge\n"
		"  repair-rhs                             [ ON | off ]   Repair rules with\n"
		"  unconnected RHS actions\n"
		"  repair-lhs                             [ ON | off ]   Repair rules with\n"
		"  unconnected LHS conditions\n"
		...
		"The interrupt-on-watched setting forces Soar to stop when it attempts to form a\n"
		"rule from a production that is being watched by the explainer. See\n"
		"explain for more information.\n"
		"The interrupt-on-failure setting forces Soar to stop when it attempts to form a\n"
		"rule but fails.\n"
	...
	docstrings["decide"] = 
		...
		"  decide indifferent-selection     [--boltzmann | --epsilon-greedy |\n"
		"  decide indifferent-selection      --first | --last | -- softmax   ]\n"
		"  decide indifferent-selection     [--epsilon --temperature] [value]\n"
		"  decide indifferent-selection     [--reduction-policy] <param> [<policy>]\n"
		"  decide indifferent-selection     [--reduction-rate] <param> <policy> [<rate>]\n"
		...
		"\n"
		"indifferent-selection Exploration Policy Parameter Auto-Reduction Policies\n"
		"\n"
		"Parameter Name      Acceptable Values Default Value\n"
	...
	docstrings["explain"] = 
		...
		"  ---------------- What to Record ---------------\n"
		"  all                                    [ on | OFF ]   Whether to record all\n"
		"  rules that are learned\n"
		"  justifications                         [ on | OFF ]   Whether to record\n"
		"  justifications\n"
		"  record <chunk-name>                                   Record any chunks\n"
		"  formed from a specific rule\n"
		"  list                                                  List all rules learned\n"
		"  ----------- Starting an Explanation -----------\n"
		"  chunk [<chunk name> | <chunk id> ]                    Start discussing chunk\n"
		"  formation                                             Describe initial\n"
		"  formation of chunk\n"
		"  ----------- Browsing an Explanation -----------\n"
		"  instantiation <inst id>                               Explain instantiation\n"
		"  explanation-trace                                     Switch to explanation\n"
		"  trace inspection\n"
		"  wm-trace                                              Switch to working\n"
		"  memory trace inspection\n"
		"  -------------- Supporting Analysis ----------------\n"
		"  constraints                                           Display extra\n"
		"  transitive constraints required by problem-solving\n"
		"  identity                                              Display identity to\n"
		"  identity set mappings\n"
		"  stats                                                 Display statistics\n"
		"  about currently discussed chunk\n"
		"\n"
		"See Also\n"
		"\n"
		"chunk visualize\n"
	...
	docstrings["load"] = 
		...
		"\n"
		"  load file            source\n"
		"  load rete-network    rete-net, rn\n"
		"  load input           replay-input\n"
		"  load library         load-libarary\n"
		"\n"
		"See Also\n"
		"\n"
	...
	docstrings["output"] = 
		...
		"  output                                       [? | help]\n"
		"  -------------------------------------------------------\n"
		"  output log                   [--append | -A] <filename>   Log all output to\n"
		"  file\n"
		"  output log                               --add <string>\n"
		"  output log                                    [--close]\n"
		"  -------------------------------------------------------\n"
		"  output command-to-file         [-a] <file> <cmd> [args]   Log execution of\n"
		"  single command\n"
		"  -------------------------------------------------------\n"
		"  print-depth                                           2   Default print depth\n"
		"  for 'print'\n"
		"  warnings                                             on   Print all warnings\n"
		"  verbose                                             off   Include verbose\n"
		"  output\n"
		"  echo-commands                                       off   Echo commands to\n"
		"  debugger\n"
		"  -------------------------------------------------------\n"
		"  To view/change a setting:                                output <setting>\n"
		"  [<value>]\n"
		...
		"Default Aliases\n"
		"\n"
		"  output command-to-file     ctf\n"
		"  output log                 clog\n"
		"  output print-depth         default-wme-depth\n"
		"  output echo-commands       echo-commands\n"
	...
	docstrings["production"] = 
		...
		"  ------------------------------------------------------------------\n"
		"  production memory-usage       [options] [max]                        Prints\n"
		"  memory usage for a type of rule\n"
		"  production memory-usage       <production_name>                      Prints\n"
		"  memory usage for a specific rule\n"
		"  ------------------------------------------------------------------\n"
		"  production optimize-multi-attribute                 [symbol [n]]\n"
		"  ------------------------------------------------------------------\n"
		"  production watch              [--disable --enable] <prod-name>\n"
		"  ------------------------------------------------------------------\n"
		"  For a detailed explanation of sub-commands:        help production\n"
		"\n"
		"Production Sub-Commands\n"
		"\n"
		"break\n"
		"\n"
		"Toggles the :interrupt flag on a rule at run-time, which stops the Soar\n"
		"decision cycle when the rule fires.\n"
		"The break command can be used to toggle the :interrupt flag on production rules\n"
		"which did not have it set in the original source file, which stops the Soar\n"
		"decision cycle when the rule fires. This is intended to be used for debugging\n"
		"purposes.\n"
		"\n"
		"Synopsis\n"
		"\n"
		...
		"Note: As of Soar 9.6, using the flag -a or --all no longer causes an init-soar.\n"
		"\n"
		"Synopsis\n"
		"\n"
		...
		"-c, --chunks    Print how many times chunks (learned productions) and\n"
		"                justifications fired\n"
		"-d, --default   Print how many timesdefault productions (:default) fired\n"
		...
		"       attribute.\n"
		"\n"
		"Optimize-multi-attribute Description\n"
		"\n"
		...
		"Note that optimize-multi-attribute declarations must be made before productions\n"
		"are loaded into soar or this command will have no effect.\n"
		"\n"
		"Optimize-multi-attribute Examples\n"
		"\n"
		"Declare the symbol \"thing\" to be an attribute likely to take more than 1 but no\n"
		"more than 4 values:\n"
		"\n"
		"  production optimize-multi-attribute thing 4\n"
		"\n"
		"watch\n"
		"\n"
		...
		"Default Aliases\n"
		"\n"
		"  production break                        pbreak\n"
		"  production excise                       ex\n"
		"  production excise                       excise\n"
		"  production find                         production-find\n"
		"  production firing-counts                firing-counts\n"
		"  production matches                      matches\n"
		"  production optimize-multi-attribute     multi-attributes\n"
		"  production watch                        pw\n"
		"  production watch                        pwatch\n"
		"\n"
		"See Also\n"
		"\n"
		"soar_init sp watch\n"
	...
	;
	docstrings["save"] = 
		"Saves rete networks and percept streams.\n"
		"\n"
		"Synopsis\n"
		"\n"
		"  ======================================================\n"
		...
		"Default Aliases\n"
		"\n"
		"  save rete-network   rete-net\n"
		"  save rete-network   rn\n"
		"  save percepts       capture-input\n"
		"\n"
		"See Also\n"
		"\n"
	...
	docstrings["soar"] = 
		...
		"  soar init                                             Re-initializes current\n"
		"  state of Soar\n"
		"  soar stop                                             Stop Soar execution\n"
		"  soar version                                          Print version number of\n"
		"  Soar\n"
		"  ----------------- Settings --------------------\n"
		"  max-elaborations                               100    Maximum elaboration in\n"
		"  a phase\n"
		"  max-goal-depth                                  23    Maximum goal stack\n"
		"  depth\n"
		"  max-nil-output-cycles                           15    Used with run --out\n"
		"  max-dc-time                                      0    Maximum time per\n"
		"  decision\n"
		"  max-memory-usage                         100000000    Maximum memory usage\n"
		"  max-gp                                       20000    Maximum rules gp can\n"
		"  generate\n"
		"  stop-phase                                   apply    Phase before which Soar\n"
		"  will stop\n"
		"  wait-snc                                       off    Wait after state-no-\n"
		"  change\n"
		"  ---------------------------------------------\n"
		"\n"
		...
		"  soar init\n"
		"\n"
		"The init-soar command re-initializes Soar. It removes all elements from working\n"
	...
	docstrings["visualize"] = 
		...
		"  visualize [wm | smem | epmem] [id] [depth]            Visualize from memory\n"
		"  system\n"
		"  visualize [ last | instantiations | contributors]     Visualize explainer\n"
		"  analysis\n"
		"  ------------------ Presentation -------------------\n"
		"  rule-format                          [ name | FULL]   Print all conditions\n"
		"  and actions or just the rule name\n"
		"  memory-format                      [ node | RECORD]   Print memories as\n"
		"  records or just simple nodes\n"
		"  line-style                                 polyline   GraphViz line style\n"
		"  that will be used\n"
		...
		"  ------------------ File Handling ------------------\n"
		"  file-name                                  soar_viz\n"
		"  use-same-file                          [ on | OFF ]   Whether to create new\n"
		"  files each time\n"
		"  generate-image                         [ ON | off ]   Whether an image should\n"
		"  be created\n"
		"  image-type                                      svg   Image type that will be\n"
		"  generated\n"
		"  ------------------ Post Actions -------------------\n"
		"  viewer-launch                          [ ON | off ]   Launch image in viewer\n"
		"  editor-launch                          [ on | OFF ]   Open data file in\n"
		"  editor\n"
		"  print-debug                            [ on | OFF ]   Print data file to\n"
		...
		"\n"
		"visualize [ last | instantiations | contributors]\n"
		"visualize last will create a visualization of the last chunk or instantiation\n"
		"printed by the explainer.\n"
		"visualize instantiation will create a visualization of the instantiation graph.\n"
		"This shows all rules that fired in a substate that contributed to a rule being\n"
		"learned. Conditions are connected to the actions that created the working\n"
		"memory elements that they matched.\n"
		"visualize contributors will create a visualization of the instantiation graph\n"
		"that also includes the chunk that was learned. In addition to all of the\n"
		"dependencies between rules, this visualization also shows which conditions in\n"
		"the instantiations tested knowledge in the superstate and hence contributed to\n"
		"a conditions in the final learned rule. For complex visualizations, sometimes\n"
		"the additional connections can make things too cluttered, which is why this is\n"
		"a separate option.\n"
		"\n"
		"Presentation Settings\n"
		"\n"
		"rule-format: This setting only applies to visualizing EBC processing. The full\n"
		"format will print all conditions and actions of the rule.\n"
		"The name format will only print a simple object with the rule name.\n"
	...
	;
	docstrings["wm"] = 
		"Commands and settings related to working memomory and working memory\n"
		"activation. There are four sub-commands: add, remove, activation and watch.\n"
		"\n"
		"Synopsis\n"
		"\n"
		"  =========================================================\n"
		...
		"  wm activation   --set <parameter> <value>\n"
		"                  <parameter> = activation  | decay-rate\n"
		"                              decay-thresh  | forgetting\n"
		"                              forget-wme    | max-pow-cache\n"
		"                              petrov-approx | timers\n"
		"  wm activation   --stats [<statistic>]\n"
		"                     <statistic> = forgotten-wmes\n"
		"  wm activation   --timers [<timer>]\n"
		"                     <timer> = wma_forgetting | wma_history\n"
		"  wm activation   --history <timetag>\n"
		"  ---------------------------------------------------------\n"
		"  wm watch        [--add-filter   ] --type <t>  pattern\n"
		"                  [--remove-filter]\n"
		"  wm watch        [--list-filter ] [--type <t>]\n"
		"                  [--reset-filter]\n"
		"                              <t> = [adds | removes | both]\n"
		"  ---------------------------------------------------------\n"
		"\n"
		...
		"through wmes created via wm add nor will such wmes ever be removed thru Soar's\n"
		...
		"Warnings\n"
		"\n"
		"wm remove should never be called from the RHS: if you try to match a wme on the\n"
		"LHS of a production, and then remove the matched wme on the RHS, Soar will\n"
		"crash.\n"
