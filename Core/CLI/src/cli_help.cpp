/* Auto-generated by gen_cli_help.sh on Sat Oct 15 13:54:34 EDT 2016 */
#include <map>
...
void initdocstrings()
{
	...
	docstrings["chunk"] = 
		...
		"  explain-interrupt                      [ on | OFF ]   Stop Soar after\n"
		"  learning rule watched by explainer\n"
		"  warning-interrupt                      [ ON | off ]   Stop Soar after\n"
		"  detecting learning issue\n"
		"  ----------------- EBC Mechanisms ------------------\n"
		"  add-osk                                [ on | OFF ]   Learn from operator\n"
		"  selection knowledge\n"
		"  lhs-repair                             [ ON | off ]   Add grounding\n"
		"  conditions for unconnected LHS identifiers\n"
		"  rhs-repair                             [ ON | off ]   Add grounding\n"
		"  conditions for unconnected RHS identifiers\n"
	...
	docstrings["production"] = 
		...
		"productions that haven't fired at all are listed. If --fired is used, the\n"
		"opposite happens. Only rules that have fired are listed. If a production name\n"
		"is given as an argument, the firing count for that production is printed.\n"
