/* Auto-generated by gen_cli_help.sh on Mon Jun 19 10:28:23 EDT 2017 */
...
void initdocstrings()
{
	...
	docstrings["chunk"] = 
		...
		"  learning\n"
		"  ------------------- Settings ----------------------\n"
		"  always | NEVER | only | except                        When Soar will learn\n"
		"  new rules\n"
		"  bottom-only                            [ on | OFF ]   Learn only from bottom\n"
		"  sub-state\n"
		"  naming-style                     [ numbered | RULE]   Numeric names or rule-\n"
		"  based names\n"
		...
		"  chunks (per rule)\n"
		"  ------------------- Debugging ---------------------\n"
		"  interrupt                              [ on | OFF ]   Stop after learning\n"
		"  from any rule\n"
		"  explain-interrupt                      [ on | OFF ]   Stop after learning\n"
		"  rule watched\n"
		"  warning-interrupt                      [ on | OFF ]   Stop after detecting\n"
		"  learning issue\n"
		"  ------------------- Fine Tune ---------------------\n"
		"  singleton                                             Print all WME\n"
		"  singletons\n"
		"  singleton                <type> <attribute> <type>    Add a WME singleton\n"
		"  pattern\n"
		"  singleton -r             <type> <attribute> <type>    Remove a WME singleton\n"
		"  pattern\n"
		"  ----------------- EBC Mechanisms ------------------\n"
		"  add-ltm-links                          [ ON | off ]   Recreate LTM links in\n"
		"  results\n"
		"  add-osk                                [ on | OFF ]   Incorporate operator\n"
		"  selection rules\n"
		...
		"  unconnected RHS IDs\n"
		"  user-singletons                        [ ON | off ]   Unify with domain\n"
		"  singletons\n"
		"  ---------- Correctness Guarantee Filters ----------\n"
		"  allow-local-negations                  [ ON | off ]   Allow local negative\n"
		"  reasoning\n"
		"  allow-opaque*                          [ ON | off ]   Allow knowledge from a\n"
		"  LTM recall\n"
		"  allow-missing-osk*                     [ ON | off ]   Allow problem-solving\n"
		"  that used OSK\n"
		"  allow-uncertain-operators*             [ ON | off ]   Allow operators decided\n"
		"  probabilist\n"
		"  allow-conflated-reasoning*             [ ON | off ]   Allow problem-solving\n"
		"  with multiple\n"
		"  * disabled\n"
		"  ---------------------------------------------------\n"
		"\n"
	...
	docstrings["decide"] = 
		...
		"  decide indifferent-selection   [--reduction-rate| -r] <param> <policy>\n"
		"  [<rate>]\n"
	...
	docstrings["explain"] = 
		...
		"  only-chunk-identities                  [ ON | off ]   Prints ID sets in chunk\n"
		...
		"  +)\n"
		"\n"
		"explain explanation-trace and explain wm-trace\n"
		"\n"
	...
	docstrings["output"] = 
		...
		"  =======================================================\n"
		"  output                                       [? | help]\n"
		"  agent-trace                 <channel-number> [on | off]   Controls agent-\n"
		"  trace\n"
		"  -------------------------------------------------------\n"
	...
	docstrings["rl"] = 
		...
		"(λ), use \"rl --set step-size-parameter [0,1]\". It controls how fast the\n"
		"secondary set of weights changes to allow GQ(λ) to improve the rate of\n"
	...
	docstrings["soar"] = 
		...
		"  ----------------- Settings --------------------\n"
		"  keep-all-top-oprefs                         off    Top state o-supported WMEs\n"
		...
		"level o-support. This allows such preferences to be examined during debugging.\n"
		"\n"
		"soar max-dc-time\n"
		"\n"
		...
		"soar tcl\n"
		"\n"
		"The tcl setting enables the TCL command line interface. It provides the ability\n"
