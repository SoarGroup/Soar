...
void initdocstrings() {
	...
	docstrings["epmem"] = 
		...
		"             Set the weight of match\n"
		"balance      cardinality in calculating   [0, 1]                    0.5\n"
		"             match score\n"
		"             Set the number of memory\n"
		"cache_size   pages used in the SQLite     1, 2, ...                 10000\n"
		"             cache\n"
		"             Set the number of episode\n"
		"commit       encodings between committing 1, 2, ...                 1\n"
		"             changes to disk\n"
		"database     Set storage location of the  file, memory              memory\n"
		"             database\n"
		...
		"             Set database policy to\n"
		"optimization optimize performance or file safety, performance       performance\n"
		"             system safety\n"
		"             Set the size of each memory  1k, 2k, 4k, 8k, 16k, 32k,\n"
		"page_size    page used in the SQLite      64k                       8k\n"
		"             cache\n"
		"path         Set the file system path for empty, some path          empty\n"
		"             the database file\n"
		"             Set the decision cycle phase\n"
		"phase        for encoding new episodes    output, selection         output\n"
		"             and processing epmem link\n"
		"             commands\n"
		"timers       Set granularity of timers    off, one, two, three      off\n"
		"trigger      Set what triggers encoding   dc, output, none          output\n"
		"             of new episodes\n"
		"\n"
		...
		"A last note is that when the path parameter is set to a non-empty value for the\n"
		"first time, the value of the database parameter is automatically changed to\n"
		"file.\n"
		"\n"
		"Statistics\n"
		"\n"
