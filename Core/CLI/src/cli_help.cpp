/* Auto-generated by gen_cli_help.sh on Sun May 25 20:32:11 EDT 2014 */
#include <map>
...
void initdocstrings() {
	...
	docstrings["epmem"] = 
		...
		"                                                              values\n"
		"append-database Controls whether database is overwritten or   on, off   off\n"
		"                appended when opening or re-initializing\n"
		"                Linear weight of match cardinality (1) vs.\n"
		"balance         working memory activation (0) used in         [0, 1]    1\n"
		"                calculating match score\n"
		"database        Database storage method                       file,     memory\n"
		"                                                              memory\n"
		"exclusions      Toggle the exclusion of an attribute string   any       epmem,\n"
		"                constant                                      string    smem\n"
		...
		"merge           Controls how retrievals interact with         none, add none\n"
		"                long-term identifiers in working memory\n"
		"path            Location of database file                     empty,    empty\n"
		"                                                              some path\n"
		"phase           Decision cycle phase to encode new episodes   output,   output\n"
		"                and process epmem link commands               selection\n"
		"                                                              dc,\n"
		...
		"When path is empty, the database is stored in main memory and will be lost when\n"
		"the agent exits. When path is set to a valid file system path, the SQLite\n"
		"database is written to that path.\n"
		"\n"
		"The append-database parameter will determine whether all existing episodes\n"
		"recorded in a database on disk will be erased when epmem loads it. Note that\n"
		"this affects episodic memory re-initialization also, i.e. if the append setting\n"
		"is off, all episodic memories stored to disk will be lost when an init-soar is\n"
		"performed.\n"
		"\n"
		"Note that changes to database, path and append-database will not have an effect\n"
		"until the database is used after an initialization. This happens either at\n"
		"launch or when an init-soar or database initialization command is issued. To\n"
		"switch databases or database storage types on the fly, set your new parameters\n"
		"and then either perform an init-soar or epmem --init.\n"
		"\n"
	...
	docstrings["rl"] = 
		...
		"\n"
		"dot -Tps rl.dot -o   ps2pdf rl.ps           Generate a .ps file and convert it\n"
		"rl.ps                                       to .pdf.\n"
		"dot -Tsvg rl.dot -o  inkscape -f rl.svg -A  Generate a .svg file and convert it\n"
		"rl.svg               rl.pdf                 to .pdf.\n"
		"\n"
	...
	docstrings["smem"] = 
		...
		"merge           Controls how retrievals interact with         none, add add\n"
		"                long-term identifiers in working memory\n"
		...
		"database is written to that path.\n"
		"\n"
		"The append-database parameter will determine whether all existing facts stored\n"
		"in a database on disk will be erased when semantic memory loads it. Note that\n"
		"this affects semantic memory re-initialization also, i.e. if the append setting\n"
		"is off, all semantic facts stored to disk will be lost when an init-soar is\n"
		"performed.\n"
		"\n"
		"Note that changes to database, path and append-database will not have an effect\n"
		"until the database is used after an initialization. This happens either at\n"
		"launch or when an init-soar or database initialization command is issued. To\n"
		"switch databases or database storage types on the fly, set your new parameters\n"
		"and then either perform an init-soar or smem --init.\n"
		"\n"
