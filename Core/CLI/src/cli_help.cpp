/* Auto-generated by gen_cli_help.sh on Sun Oct  9 18:38:43 EDT 2016 */
#include <map>
...
void initdocstrings()
{
	...
	docstrings["smem"] = 
		...
		"semantic memory. The command trace --smem displays additional trace information\n"
	...
	docstrings["soar"] = 
		...
		"  Soar\n"
		"  ----------------- Settings --------------------\n"
		"  max-elaborations                            100    Maximum elaboration in a\n"
		"  decision cycle\n"
		"  max-goal-depth                               23    Halt if goal stack reaches\n"
		"  this depth\n"
		"  max-nil-output-cycles                        15    Impasse only after this\n"
		"  many nil outputs\n"
		"  max-dc-time                                   0    Interrupt decision after\n"
		"  this much time\n"
		...
		"  (see help)\n"
		"  timers                                       on    Profile where Soar spends\n"
		"  its time\n"
	...
	docstrings["trace"] = 
		...
		"                                            Controls printing of\n"
		"-G, --gds          remove (optional)        warnings about wme changes\n"
		"                                            to GDS\n"
