/* Auto-generated by gen_cli_help.sh on Thu Sep 15 17:38:37 EDT 2016 */
#include <map>
...
void initdocstrings()
{
	...
	docstrings["chunk"] = 
		...
		"chunk always: Soar will always attempt to learn rules from sub-state problem-\n"
		"solving. chunk never: Soar will never attempt to learn rules. chunk all-except:\n"
		"Chunking is on in all states except those that have had RHS dont-learn actions\n"
		"executed in them. chunk flagged: Chunking is off for all states except those\n"
		"that are flagged via a RHS force-learn actions.\n"
