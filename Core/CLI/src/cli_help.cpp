/* Auto-generated by gen_cli_help.sh on Wed Jun 10 15:55:33 EDT 2015 */
#include <map>
...
void initdocstrings()
{
	...
	;
	docstrings["indifferent_selection"] = 
	...
	;
	docstrings["max_nil_output_cycles"] = 
	...
	;
	docstrings["numeric_indifferent_mode"] = 
	...
	docstrings["pbreak"] = 
		...
		"\n"
		"<production-name>\n"
		"| Clear :interrupt flag from a production. | | -p, --print | (none) | Print\n"
		"which production rules have had their :interrupt flags set. | | (none) | (none)\n"
		"| Print which production rules have had their :interrupt flags set. | | -s, --\n"
		"set |\n"
		"<production-name>\n"
		"| Set :interrupt flag on a production rule. | | (none) |\n"
		"<production-name>\n"
	...
	docstrings["rl"] = 
		...
		"\n"
		"dot -Tps rl.dot -o rl.ps   ps2pdf rl.ps         Generate a .ps file and\n"
		"                                                convert it to .pdf.\n"
		"dot -Tsvg rl.dot -o rl.svg inkscape -f rl.svg - Generate a .svg file and\n"
		"                           A rl.pdf             convert it to .pdf.\n"
		"\n"
	...
	docstrings["save_backtraces"] = 
		...
		"retrieved by using the [_explain_backtraces explain-backtraces] command. Saving\n"
		"backtracing information may slow down the execution of your Soar program, but\n"
		"it can be a very useful tool in understanding how chunks are formed.\n"
		"\n"
		"See Also\n"
		"\n"
		"explain-backtraces\n"
	...
	docstrings["select"] = 
		...
		"predict\n"
	;
	docstrings["set_library_location"] = 
	...
	docstrings["smem"] = 
		...
		"merge     Controls how retrievals interact with long- none, add        add\n"
		"          term identifiers in working memory\n"
		"mirroring Controls automatic encoding of working-     on, off          off\n"
		"          memory changes\n"
		"path      Location of database file                   empty, some path empty\n"
		"\n"
		"The learning parameter turns the episodic memory module on or off. When\n"
		...
		"init will reinitialize episodic, semantic, procedural, and working memories. It\n"
		"is equivalent to wiping the semantic store and executing these commands:\n"
		"\n"
		"  epmem --close\n"
		"  excise --all\n"
		"  init-soar\n"
		...
		"print option has the same syntax, but outputs text that is similar to using the\n"
		"print command to get the substructure of an identifier in working memory, which\n"
		"is possibly more useful for interactive debugging.\n"
		"\n"
		"See Also\n"
		"\n"
		"watch\n"
