/* Auto-generated by gen_cli_help.sh on Wed Oct 12 14:40:59 EDT 2016 */
#include <map>
...
void initdocstrings()
{
	...
	docstrings["debug"] = 
		...
		"\n"
		"This debug command allocates additional blocks of memory for a specified memory\n"
		"pool. Each block is 32 kilobyte.\n"
	...
	docstrings["explain"] = 
		...
		"  i 31\n"
		"  9:    (<i2> ^output-link <i1>)                             ([163] ^output-\n"
		"  link [164])                        i 31\n"
		"  10:   (<i1> ^gripper <g2>)                                 ([164] ^gripper\n"
		"  [165])                            i 31\n"
		"  11:   (<s2> ^clear { <> <t1> <b1> })                       ([162] ^clear { <>\n"
		"  [161]  [161] })                 i 30 -> i 31\n"
		"  12:   (<s1> ^operator <o1>)                                ([140] ^operator\n"
		"  [149])\n"
		"  13:   (<o1> ^moving-block <b1>)                            ([149] ^moving-\n"
		"  block [161])\n"
		"  14:   (<o1> ^name pick-up)                                 ([149] ^name pick-\n"
		"  up)\n"
		"        -->\n"
		...
		"will be listed in the intial formation output.\n"
		"\n"
		...
		"  apply*move-gripper-above*pass*top-state at level 3)\n"
		"   (produced chunk result)\n"
		"                                                          Identities instead of\n"
		"  variables            Operational    Creator\n"
		"\n"
		"  1:    (<s> ^operator <op>)                              ([159] ^operator\n"
		"  [160])                        No         i 30 (pick-up*propose*move-gripper-\n"
		"  above)\n"
		"  2:    (<op> ^name move-gripper-above)                   ([160] ^name move-\n"
		"  gripper-above)               No         i 30 (pick-up*propose*move-gripper-\n"
		"  above)\n"
		"  3:    (<op> ^destination <des>)                         ([160] ^destination\n"
		"  [161])                     No         i 30 (pick-up*propose*move-gripper-\n"
		"  above)\n"
		"  4:    (<s> ^top-state <t*1>)                            ([159] ^top-state\n"
		"  [162])                       No         i 27 (elaborate*state*top-state)\n"
		"  5:    (<t*1> ^io <i*1>)                                 ([162] ^io [163])\n"
		"  Yes        Higher-level Problem Space\n"
		"  6:    (<i*1> ^output-link <o*1>)                        ([163] ^output-link\n"
		"  [164])                     Yes        Higher-level Problem Space\n"
		"  7:    (<o*1> ^gripper <gripper>)                        ([164] ^gripper\n"
		"  [165])                         Yes        Higher-level Problem Space\n"
		"     -->\n"
		"  1:    (<gripper> ^command move-gripper-above +)         ([165] ^command move-\n"
		"  gripper-above +)\n"
		"  2:    (<gripper> ^destination <des> +)                  ([165] ^destination\n"
		"  [161] +)\n"
		"  ------\n"
		...
		"  2:    (S9 ^desired D6)                                      No         i 29\n"
		"  (pick-up*elaborate*desired)\n"
		"  3:    (D6 ^moving-block B3)                                 No         i 29\n"
		"  (pick-up*elaborate*desired)\n"
		...
		"\n"
		"Soar's visualize command allows you to create an image that shows the entire\n"
		"instantiation graph at once, with arrows showing the dependencies between\n"
		"actions in one rule and conditions in others. This image is one of the most\n"
		"effective ways to understand how a chunk was formed, especially for\n"
		"particularly complex chunks. To use this feature, first choose a chunk for\n"
		"discussion. You can then issue the visualize command with the appropriate\n"
		"settings.\n"
		"\n"
		"Default Aliases\n"
		"\n"
	...
	docstrings["production"] = 
		...
		"       attribute.\n"
		"\n"
		"Optimize-attribute Description\n"
		"\n"
		...
		"  multi-attributes           production optimize-multi-attribute\n"
		"  pw                         production watch\n"
	...
	docstrings["soar"] = 
		...
		"max-gp\n"
		"\n"
		"'max-gp' is used to limit the number of productions produced by a gp command.\n"
		"It is easy to write a gp rule that has a combinatorial explosion and hangs for\n"
		"a long time while those productions are added to memory. The gp-max command\n"
		"bounds this.\n"
		"\n"
		"max-memory-usage\n"
		"\n"
		...
		"tcl\n"
		"\n"
		"The tcl command enables the TCL command line interface. It provides the ability\n"
		"to run Tcl code from any Soar command line. When the on parameter is given, all\n"
		"future Soar commands will be passed to a Tcl interpreter for processing.\n"
		"Note that you cannot turn Tcl on and use Tcl code within the same file. If\n"
		"you'd like to have Tcl turned on automatically when Soar launches, add the tcl\n"
		"on command to your settings.soar file in the main Soar directory. This\n"
