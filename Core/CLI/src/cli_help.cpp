/* Auto-generated by gen_cli_help.sh on Tue Oct  9 14:33:47 EDT 2012 */
#include <map>
...
void initdocstrings() {
	...
	docstrings["learn"] = 
		...
		"--enable-through-local-negations  in backtraces. (default)\n"
		"-N,                               Do not build chunks when local negation\n"
		"--disable-through-local-negations encountered in backtraces.\n"
		"-p, --add-desirability-prefs      Add relevant desirability preferences to\n"
		"                                  backtraces.\n"
		"-P,                               Do not add any desirability preferences to\n"
		"--do-not-add-desirability-prefs   backtraces. (default)\n"
		"\n"
		"Description \n"
		"\n"
		...
		"of learning in Soar.\n"
		"\n"
		"The final six settings, --all-levels, --bottom-up,\n"
		"--enable-through-local-negations, --disable-though-local-negations,\n"
		"--add-desirability-prefs and --do-not-add-desirability-prefs, are orthogonal to\n"
		"the --on, --except, --only, and --off flags, and so, may be used in combination\n"
		"with them.\n"
		"\n"
		...
		"--disable-though-local-negations control whether or not chunks can be created\n"
		"that are derived from rules that check for negated WMEs on the substate (local\n"
		...
		"\n"
		"The options --add-desirability-prefs and --do-not-add-desirability-prefs\n"
		"control whether or not desirability preferences are added to the context\n"
		"dependent preference set, which is the set of operator evaluation preferences\n"
		"that led to the selection of an operator in a subgoal. All preferences in the\n"
		"CDPS are backtraced through when creating justifications and chunks. When this\n"
		"option is disabled, only requirement preferences (requires and prohibits) will\n"
		"be added to the CDPS. When this option is enabled, relevant desirability prefs\n"
		"(better, best, worse, worst, indifferent) will also be added. The default is to\n"
		"not include desirability preferences.\n"
		"\n"
	...
	docstrings["rl"] = 
		...
		"settings.\n"
		"\n"
		"                             Automatic excising of       none, chunks,\n"
		"apoptosis                    productions via base-level  rl-chunks       none\n"
		"                             decay\n"
		"apoptosis-decay              Base-level decay parameter  [0, 1]          0.5\n"
		"                             Base-level threshold\n"
		"apoptosis-thresh             parameter (negates supplied (0, inf)        2\n"
		"                             value)\n"
		"                             If enabled, chunking does\n"
		"                             not create duplicate RL\n"
		"chunk-stop                   rules that differ only in   on, off         on\n"
		"                             numeric-indifferent\n"
		"                             preference value\n"
		"                                                         normal,\n"
		"decay-mode                   How the learning rate       exponential,    normal\n"
		"                             changes over time           logarithmic,\n"
		"                                                         delta-bar-delta\n"
		"discount-rate                Temporal discount (gamma)   [0, 1]          0.9\n"
		"eligibility-trace-decay-rate Eligibility trace decay     [0, 1]          0\n"
		"                             factor (lambda)\n"
		"eligibility-trace-tolerance  Smallest eligibility trace  (0, inf)        0.001\n"
		"                             value not considered 0\n"
		"                             Discounting of RL updates\n"
		"hrl-discount                 over time in impassed       on, off         off\n"
		"                             states\n"
		...
		"                             gaps\n"
		"temporal-extension           Propagation of RL updates   on, off         on\n"
		"                             over gaps\n"
		...
		"\"meta-learning-rate\" and each rule gets two additional decay parameters: beta\n"
		"and h. The meta learning rate is set manually; the per-rule features are\n"
		"handles automatically by the DBD algorithm. The key idea is that the meta\n"
		...
		"subsequent updates in the same direction will have more effect. So DBD acts\n"
		"sort of like momentum for the learning rate.\n"
		"\n"
		...
		"\"rl\", under the Experimental section you'll see the current settings for\n"
		...
		"e.g. \"rl --set update-log-path rl_log.txt\". Disable with <rl --set\n"
		"update-log-path \"\"> - that is, use the empty string \"\" as the log path. The\n"
		"current log path appears under the experimental section when you execute \"rl\".\n"
		"\n"
		"See Also \n"
		"\n"
		"excise print watch\n"
	...
	docstrings["smem"] = 
		...
		"                          Controls how retrievals\n"
		"merge                     interact with long-term       none, add   add\n"
		"                          identifiers in working memory\n"
		"mirroring                 Controls automatic encoding   on, off     off\n"
		"                          of working-memory changes\n"
		...
		"is not in working memory or has no augmentations in working memory, this\n"
		"parameter has no effect. If the augmentation is in working memory and has\n"
		"augmentations, by default (add), semantic memory will add any augmentations\n"
		"that augmented the LTI in a retrieved LTI are added to working memory. If the\n"
		"parameter is set to none then semantic memory will not augment the LTI. Note\n"
		"this is opposite of the value of the same parameter in episodic memory.\n"
		"\n"
		"The mirroring parameter controls a useful form of automatic encoding. If\n"
		"enabled (on), all changes to long-term identifiers (LTIs) in working memory are\n"
		"\"mirrored\" to semantic memory (assuming the LTI in working memory has at least\n"
		"one augmentation - i.e. no accidental clearing). The mirrors statistic is\n"
		"incremented for each LTI that is updated in this way.\n"
		"\n"
		"Statistics \n"
		"\n"
		...
		"mem-high       Memory         High SQLite memory usage watermark in bytes\n"
		"               Highwater\n"
		"mirrors        Mirrors        Number of LTIs that have been automatically\n"
		"                              encoded via mirroring\n"
