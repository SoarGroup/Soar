...
const char* m_X11_Colors[437] =
{
    "paleturquoise", "mistyrose1", "antiquewhite", "antiquewhite1", "antiquewhite2", "antiquewhite3",
    ...
    "bisque3", "bisque4", "blanchedalmond", "blue", "blue1", "blue2", "blue3", "blue4",
    ...
    "cyan3", "cyan4", "darkgoldenrod", "darkgoldenrod1", "darkgoldenrod2", "darkgoldenrod3",
    ...
    "firebrick4", "floralwhite", "forestgreen", "gainsboro", "ghostwhite", "gold", "gold1",
    ...
    "indianred3", "indianred4", "indigo", "invis", "ivory", "ivory1", "ivory2", "ivory3",
    ...
    "lightyellow4", "limegreen", "linen", "magenta", "magenta1", "magenta2", "magenta3",
    "magenta4", "maroon", "maroon1", "maroon2", "maroon3", "maroon4", "mediumaquamarine",
    "aliceblue", "mediumblue", "mediumorchid", "mediumorchid1", "mediumorchid2", "mediumorchid3",
    ...
    "navajowhite1", "navajowhite2", "navajowhite3", "navajowhite4", "navy", "navyblue",
    "oldlace", "olivedrab", "olivedrab1", "olivedrab2", "olivedrab3", "olivedrab4", "orange",
    ...
    "powderblue", "purple", "purple1", "purple2", "purple3", "purple4", "red", "red1", "red2",
    ...
    "seashell3", "seashell4", "sienna", "sienna1", "sienna2", "sienna3", "sienna4", "skyblue",
    ...
    "slategray4", "slategrey", "springgreen", "springgreen1", "springgreen2", "springgreen3",
    "springgreen4", "steelblue", "steelblue1", "steelblue2", "steelblue3", "steelblue4",
    "tan", "tan1", "tan2", "tan3", "tan4", "thistle", "thistle1", "thistle2", "thistle3",
    "thistle4", "tomato", "tomato1", "tomato2", "tomato3", "tomato4", "transparent",
    "turquoise", "turquoise1", "turquoise2", "turquoise3", "turquoise4", "violet",
    "violetred", "violetred1", "violetred2", "violetred3", "violetred4", "wheat", "wheat1",
    "wheat2", "wheat3", "wheat4", "whitesmoke", "yellow", "yellow1", "yellow2", "yellow3",
    "yellow4", "yellowgreen"
};

const char* m_X11_GrayColors[215] =
{
    ...
    "gray97", "gray98", "gray99", "green", "green1", "green2", "green3", "green4",
    "greenyellow", "grey", "grey0", "grey1", "grey10", "grey100", "grey11", "grey12",
