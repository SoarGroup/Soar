...
namespace soar_module
{
	...
	// set_param
	/////////////////////////////////////////////////////////////
	set_param::set_param( const char *new_name, predicate<const char *> *new_prot_pred, agent *new_agent ): param( new_name ), prot_pred( new_prot_pred ), my_agent( new_agent )
	{
	...
	bool set_param::in_set( Symbol *test_sym )
	{
