...
enum TraceMode
{
    ...
    DT_EXPLAIN                  = 22,
    DT_EXPLAIN_PATHS            = 23,
    DT_EXPLAIN_ADD_INST         = 24,
    DT_EXPLAIN_CONNECT          = 25,
    DT_EXPLAIN_UPDATE           = 26,
    DT_EXPLAIN_CONDS            = 27,
    DT_EXPLAIN_IDENTITIES       = 28,
    DT_EXPLAIN_CACHE            = 29,
    ...
    DT_ALLOCATE_RHS_VALUE       = 36,
    DT_ID_LEAKING               = 37,
    DT_DEALLOCATE_INST          = 38,
    DT_DEALLOCATE_PREF          = 39,
    DT_DEALLOCATE_PROD          = 40,
    DT_DEALLOCATE_RHS_VALUE     = 41,
    DT_DEALLOCATE_SLOT          = 42,
    DT_DEALLOCATE_SYMBOL        = 43,
    DT_DEALLOCATE_TEST          = 44,
    DT_REFCOUNT_ADDS            = 45,
    DT_REFCOUNT_REMS            = 46,
