...
inline double smem_lti_activate( agent *my_agent, smem_lti_id lti, uint64_t num_edges = SMEM_ACT_MAX )
{
	////////////////////////////////////////////////////////////////////////////
...
{	
	...
	{
		double lti_act = smem_lti_activate( my_agent, parent_id, new_edges );
