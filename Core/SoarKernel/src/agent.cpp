...
agent* create_soar_agent(char* agent_name)                                               /* loop index */
{
    ...
    newAgent->chunky_problem_spaces              = NIL;
    strcpy(newAgent->chunk_name_prefix, "chunk");
