...
//#endif
  ...
  newAgent->wma_params[ WMA_PARAM_FORGETTING ] = wma_add_parameter( "forgetting", WMA_FORGETTING_ON, &wma_validate_forgetting, &wma_convert_forgetting, &wma_convert_forgetting );
