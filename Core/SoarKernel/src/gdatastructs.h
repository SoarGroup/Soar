...
typedef struct preference_struct {
  ...
  /* -- These pointers store the unique original
   *    variable names associated with a preference
   *    generated by a rhs action.  It is used by the
   *    chunker to match up rhs symbols with the correct
