...
class smem_statement_container : public SMemExperimental::statement_container
{
    public:
        ...
        SQLite::Statement web_attr_all_no_spread;
        SQLite::Statement web_const_all_no_spread;
        SQLite::Statement web_lti_all_no_spread;
        ...
        SQLite::Statement trajectory_invalidation_check_for_rows;
