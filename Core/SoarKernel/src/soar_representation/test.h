...
void add_bound_variables_in_test_with_identity(agent* thisAgent, test t, test t_counterpart, tc_number tc, ungrounded_symbol_list* var_list, bool add_LTIs = false);
