...
//            decide_params = new memory_param_container(thisAgent);
//            load_save_params = new memory_param_container(thisAgent);
//            production_params = new memory_param_container(thisAgent);
//            wm_params = new memory_param_container(thisAgent);
}
