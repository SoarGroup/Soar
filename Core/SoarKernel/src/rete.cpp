...
void reteload_node_and_children (agent* thisAgent, rete_node *parent, FILE* f) {
  ...
  */
  ...
  prod->rl_variance_tolerable = 0.0001; ///< bazald
  prod->rl_variance_0 = 0.0; ///< bazald
  prod->rl_variance_rest = 0.0; ///< bazald
  prod->rl_variance_total = 0.0; ///< bazald
  ...
  prod->total_fired_last = 0; ///< bazald
  prod->total_updated_last = 0; ///< bazald
  ...
  prod->rl_update_num = 0.0; ///< bazald
  prod->rl_update_denom = 0.0; ///< bazald
