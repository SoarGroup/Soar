...
class literal : public serializable
{
    public:
        ...
        {
            return name == l.name && args == l.args && negate == l.negate;
        }
        ...
        const int_tuple& get_args() const
        {
            return args;
        }
        bool negated() const
...
class FOIL
{
    public:
        ...
        const relation_table& get_relations() const
        {
            return *rels;
        }
        const relation& get_pos() const
        {
            return pos;
        }
        const relation& get_neg() const
        {
            return neg;
        }
        const relation& get_rel(const std::string& name) const;
        
        const int num_clauses() const
        {
            return clauses.size();
        }
        const clause& get_clause(int i) const
        {
            return clauses[i].cl;
        }
        const relation& get_false_positives(int i) const
        {
            return clauses[i].false_positives;
        }
        const relation& get_true_positives(int i) const
        {
            return clauses[i].true_positives;
        }
        const relation& get_false_negatives() const
        {
            return false_negatives;
        }
        const relation& get_true_negatives() const
        {
