...
class model_train_data : public serializable, public cliproxy
{
    public:
        ...
        const model_train_inst& get_inst(int t)  const
        {
            return *insts[t];
        }
        const model_train_inst& get_last_inst()  const
        {
            return *insts.back();
        }
        const relation_table& get_all_rels()     const
        {
            return all_rels;
        }
        const relation_table& get_context_rels() const
        {
            return context_rels;
        }
...
class model : public serializable, public cliproxy
{
    public:
        ...
        const model_train_data& get_data() const
        {
            return train_data;
        }
