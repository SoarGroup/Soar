...
class filter_input
{
    public:
        ...
        void add(filter_params* p)
        {
            result.add(p);
        }
        void remove(const filter_params* p)
        {
            result.remove(p);
        }
        void change(const filter_params* p)
        {
            result.change(p);
        }
        ...
        int  first_added() const
        {
            return result.first_added();
        }
        int  num_current() const
        {
            return result.num_current();
        }
        int  num_changed() const
        {
        ...
        const filter_params* get_current(int i) const
        {
            return result.get_current(i);
        }
        const filter_params* get_changed(int i) const
        {
            return result.get_changed(i);
        }
        const filter_params* get_removed(int i) const
        {
            return result.get_removed(i);
        }
