...
void soar_ecBuildInfo( ) {
	...
	print(glbAgent, "\nSoar v.");
	print(glbAgent, soar_version_string);
	print(glbAgent,  " Build Information.\n" );
	...
	print( glbAgent, " - CALLBACK_H_INCLUDED\n" );
#endif
...
#ifdef DONT_ALLOW_VARIABLIZAION
	print( " - DONT_ALLOW_VARIABLIZAION\n" );
#endif
	...
	print(glbAgent, " - MAX_SIMULTANEOUS_AGENTS\n" );
#endif
...
void soar_ecExcludedBuildInfo( ) {
	...
	print(glbAgent, "\nSoar v. ");
	print(glbAgent, soar_version_string);
	print(glbAgent, " Excluded Build Information.\n" );
