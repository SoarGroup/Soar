...
CartPole::~CartPole() {
  ...
  std::cerr << "\n\nObserved x = [" << m_min_x << ", " << m_max_x << "]\n"
            << "Observed x_dot = [" << m_min_x_dot << ", " << m_max_x_dot << "]\n"
            << "Observed theta = [" << m_min_theta << ", " << m_max_theta << "]\n"
            << "Observed theta_dot = [" << m_min_theta_dot << ", " << m_max_theta_dot << "]" << std::endl;
}
