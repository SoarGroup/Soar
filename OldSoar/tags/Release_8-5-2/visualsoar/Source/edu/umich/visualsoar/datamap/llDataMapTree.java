...
public class DataMapTree extends JTree implements ClipboardOwner, DragGestureListener, DropTargetListener, DragSourceListener {
...
////////////////////////////////////////
  ...
  private static JMenuItem ChangeToStringItem = new JMenuItem("to String");
    ...
    ChangeToIdentifierItem.addActionListener(new ActionListener() {
    ...
    ChangeToEnumerationItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
        dmt.changeTypeTo(1);
      }
    ...
    ChangeToIntegerItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
        dmt.changeTypeTo(2);
      }
    ...
    ChangeToFloatItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
        dmt.changeTypeTo(3);
      }
    ...
    ChangeToStringItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
        dmt.changeTypeTo(4);
      }
		...
		AddIdentifierItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
				dmt.addIdentifier();
			}
		...
		AddEnumerationItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
				dmt.addEnumeration();
			}
		...
		AddIntegerItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
				dmt.addInteger();
			}
		...
		RenameAttributeItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
				dmt.renameEdge();
			}
    ...
    RemoveCommentItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
				dmt.removeComment();
			}
    ...
    ValidateEntryItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
        dmt.validateEntry();
      }
    ...
    ValidateAllItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DataMapTree dmt = (DataMapTree)contextMenu.getInvoker();
        dmt.validateAll();
      }
	...
	// Drag and Drop Operation Variables //
...
*/
   ...
   */
	private void copy() {
		...
		clipboard.setContents(copyVerticies, this);
	}
	...
	class DMTDragGestureListener implements DragGestureListener {
		public void dragGestureRecognized(DragGestureEvent dge) {
			...
			if (action == DnDConstants.ACTION_LINK) {
				DragSource.getDefaultDragSource().startDrag(dge, DragSource.DefaultLinkDrop, t, new DMTDragSourceListener());
			}
...
*/
  ...
  public void dragGestureRecognized(DragGestureEvent dge) {
      ...
      // Select the appropriate starting cursor
      ...
      // begin the drag
      dragSource.startDrag(dge, cursor, t, this);
		}
...
*/
  ...
  public boolean isDropOK(int x, int y, int action) {
    TreePath path = getPathForLocation(x, y);
    if (path == null) return false;
    if (action == DnDConstants.ACTION_LINK || action == DnDConstants.ACTION_MOVE || action == DnDConstants.ACTION_COPY) {
      FakeTreeNode ftn = (FakeTreeNode)path.getLastPathComponent();
