...
proc setUpSoarTerm w {
    ...
    # Control-C stops run
  #  bind $w <Control-c> {tsiDisplayAndSendCommand stop-soar}
    
    # Next line change to escape by Mazin for personal copy to override
    # control-c's binding to be for copy
