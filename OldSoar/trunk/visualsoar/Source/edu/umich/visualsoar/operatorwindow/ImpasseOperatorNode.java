...
class ImpasseOperatorNode extends SoarOperatorNode {
	 ...
	 * dataMapId
	 */
	public ImpasseOperatorNode(String inName,int inId,String inFileName,String inFolderName,SoarIdentifierVertex inDataMapId) {
  ...
  /**
   *  Searches the datamap associated with this node if it owns one, looking for
   *  any portions of the datamap that were not tested by any productions and are
   *  not located within the output-link.
   */
