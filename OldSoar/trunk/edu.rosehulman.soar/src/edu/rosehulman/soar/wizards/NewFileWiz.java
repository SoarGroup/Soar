...
/**
 * This wizard is not currently in use.
 * 
 * @author Tim Jasko
 */

public class NewFileWiz extends Wizard implements INewWizard {
	private NewFileWizPage1 page;
	...
	public void addPages() {
		page = new NewFileWizPage1(selection);
		addPage(page);
	}
