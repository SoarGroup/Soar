...
public class PrintEventHandlerPlusData extends EventHandlerPlusData {
  ...
  protected PrintEventHandlerPlusData() {
    this(0, false);
  }
  ...
  public void setM_Handler(SWIGTYPE_p_f_enum_sml__smlPrintEventId_p_void_p_sml__Agent_p_q_const__char__void m_Handler) {
    smlJNI.set_PrintEventHandlerPlusData_m_Handler(swigCPtr, SWIGTYPE_p_f_enum_sml__smlPrintEventId_p_void_p_sml__Agent_p_q_const__char__void.getCPtr(m_Handler));
  }

  public SWIGTYPE_p_f_enum_sml__smlPrintEventId_p_void_p_sml__Agent_p_q_const__char__void getM_Handler() {
    long cPtr = smlJNI.get_PrintEventHandlerPlusData_m_Handler(swigCPtr);
