...
public class LayoutMenu
{
	...
	private AbstractAction m_UseTextLayout = new AbstractAction("Use text view layout")  { public void actionPerformed(ActionEvent e) { useTextLayout(e) ; } } ;
	...
	/** Create this menu */
	public static LayoutMenu createMenu(MainFrame frame, Document doc, String title, char mnemonicChar)
	{
