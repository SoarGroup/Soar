...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Aug 17, 2005
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.11.1.175185 Win32/x86, Wed Aug 17 12:01:20 PM Pacific Daylight Time 2005
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1124305280}
	buildtime,fmt {Wed Aug 17 12:01:20 PM Pacific Daylight Time 2005}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.11.1.175185 Win32/x86 @ Wed Aug 17 12:01:20 PM Pacific Daylight Time 2005 / normal}
    }
}

package provide {ActiveTcl} {8.4.11.1.175185}
