...
{		
	...
	// BADBAD: Now that we have a specific AFTER_OUTPUT_PHASE event we should use that rather than registering for all phase events
	// and only acting on the output one.
