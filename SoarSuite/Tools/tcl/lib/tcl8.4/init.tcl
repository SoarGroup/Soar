...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Jun 13, 2005
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.10.1.149958 Win32/x86, Mon Jun 13 10:43:13 AM Pacific Daylight Time 2005
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1118684593}
	buildtime,fmt {Mon Jun 13 10:43:13 AM Pacific Daylight Time 2005}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.10.1.149958 Win32/x86 @ Mon Jun 13 10:43:13 AM Pacific Daylight Time 2005 / normal}
    }
}

package provide {ActiveTcl} {8.4.10.1.149958}
