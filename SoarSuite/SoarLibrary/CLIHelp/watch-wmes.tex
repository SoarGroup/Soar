...
\hline
\soar{\soar{ -a, --add-filter }} & Add a filter to print wmes that meet the type and pattern criteria.  \\
\hline
\soar{\soar{ -r, --remove-filter }} & Delete filters for printing wmes that match the type and pattern criteria.  \\
\hline
\soar{\soar{ -l, --list-filter }} & List the filters of this type currently in use. Does not use the pattern argument.  \\
\hline
\soar{\soar{ -R, --reset-filter }} & Delete all filters of this type. Does not use pattern arg.  \\
\hline
\soar{\soar{ -t, --type }} & Follow with a type of wme filter, see below.  \\
\hline
\end{tabular}
\paragraph*{Pattern}
\emph{id}
...
\hline
\soar{\soar{ adds }} & Print info when a wme is \emph{added}
.  \\
\hline
\soar{\soar{ removes }} & Print info when a wme is \emph{retracted}
.  \\
\hline
\soar{\soar{ both }} & Print info when a wme is added \emph{or}
 retracted.  \\
\hline
\end{tabular}
