...
\hline
\soar{\soar{ -0, -n, --none }} & Print just the preferences themselves  \\
\hline
\soar{\soar{ -1, -N, --names }} & Print the preferences and the names of the productions that generated them  \\
\hline
\soar{\soar{ -2, -t, --timetags }} & Print the information for the --names option above plus the timetags of the wmes matched by the LHS of the indicated productions  \\
\hline
\soar{\soar{ -3, -w, --wmes }} & Print the information for the --timetags option above plus the entire wme matched on the LHS.  \\
\hline
\soar{\soar{ -o, --object }} & Print the support for all the wmes that comprise the object (the specified ID).  \\
\hline
\soar{\soar{id}} & Must be an existing Soar object identifier.  \\
\hline
\soar{\soar{attribute}} & Must be an existing \emph{\^{}attribute}
