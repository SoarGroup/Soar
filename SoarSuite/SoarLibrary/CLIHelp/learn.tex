...
\hline
\soar{\soar{\soar{ -e, --enable, --on }}} & Turn chunking on. Can be modified by -a or -b.  \\
\hline
\soar{\soar{\soar{ -d, --disable, --off }}} & Turn all chunking off. (default)  \\
\hline
\soar{\soar{\soar{ -E, --except }}} & Learning is on, except as specified by RHS \textbf{dont-learn}
 actions.  \\
\hline
\soar{\soar{\soar{ -o, --only }}} & Chunking is on only as specified by RHS \textbf{force-learn}
 actions.  \\
\hline
\soar{\soar{\soar{ -l, --list }}} & Prints listings of dont-learn and force-learn states.  \\
\hline
\soar{\soar{\soar{ -a, --all-levels }}} & Build chunks whenever a subgoal returns a result. Learning must be --enabled.  \\
\hline
\soar{\soar{\soar{ -b, --bottom-up }}} & Build chunks only for subgoals that have not yet had any subgoals with chunks built. Learning must be --enabled.  \\
\hline
\end{tabular}
