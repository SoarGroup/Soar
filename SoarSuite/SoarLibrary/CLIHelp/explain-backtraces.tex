...
\hline
\soar{\soar{\soar{ (no args) }}} & List all productions that can be ``explained''  \\
\hline
\soar{\soar{\soar{ prod\_name }}} & List all conditions and grounds for the chunk or justification.  \\
\hline
\soar{\soar{\soar{ -c, --condition }}} & Explain why condition number \emph{n}
 is in the chunk or justification.  \\
\hline
\soar{\soar{\soar{ -f, --full }}} & Print the full backtrace for the named production  \\
\hline
\end{tabular}
...
\hline
\soar{\soar{\soar{ eb }}} & explain-backtraces  \\
\hline
\end{tabular}
