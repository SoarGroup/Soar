...
public class ButtonView extends AbstractFixedView
{
	...
	********************************************************************************************/
	private void setPrefSize()
	{
		...
		Object key = parent2.getData(edu.umich.soar.debugger.manager.MainWindow.kAttachKey) ;
	...
	* 
	*************************************************************************/
	public edu.umich.soar.debugger.general.JavaElementXML convertToXML(String title, boolean storeContent)
	{
