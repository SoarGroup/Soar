...
/********************************************************************
 * InfluenceMap::init_game - Initialize an enemy/friendly influence map
 * Map can be updated every turn using refresh units method.  Influence
 * map can be wiped using clear_all, and can be wiped except for terrain
 * objects using clear_units.
 ********************************************************************/
...
/********************************************************************
 * InfluenceMap::init_map - Initialize the terrain influence map using
 * areas with heights above zero as unwalkable, and those with height 
 * zero as walkable.
 ********************************************************************/
...
/********************************************************************
 * InfluenceMap::clear_all - turns all cells to zero
 ********************************************************************/
...
/********************************************************************
 * InfluenceMap::clear_units - turns all cells that are not terrain
 * cells to zero.  Terrain cells are left untouched.
 ********************************************************************/
