...
namespace SortsSimpleTerrain
{
  ...
  //-----------------------------------------------------------------------------
  SortsST_Terrain::SortsPFEngine::SortsPFEngine(sint4 tiles_x_, sint4 tiles_y_, sint4 tile_points_, int gran)
  ...
  bool SortsST_Terrain::SortsPFEngine::find_path(const SortsSimpleTerrain::Loc &start,
                                       const SortsSimpleTerrain::Loc &goal, 
                                       SortsSimpleTerrain::Path& output)
  {
    SortsSimpleMap<AStarCell> amap(map.get_w(), map.get_h());
    MapPtr m = &map;
    //MapPtr m = (obj->get_zcat() == Object::ON_LAND)? &map : &air_map;
    Vector<SortsSimpleTerrain::Loc> path;
    Vector<SortsSimpleTerrain::Loc> clear;
    ...
    b.set_center(SortsSimpleTerrain::Loc(x1, y1));
    ...
    if (!found) {
      ...
      //    sint4 x1, y1, x2, y2;
      path.push_back( goal );
      //    path.push_back(SortsSimpleTerrain::Loc(x2world(x2),y2world(y2)));
      ...
      do {
        ...
        if (p) {
          ...
          path.push_back(SortsSimpleTerrain::Loc(x2,y2));
          //       uint4 i = path.size()-1;
  ...
  void SortsST_Terrain::SortsPFEngine::clearGobLocation(const Object *obj) {
  ...
  void SortsST_Terrain::SortsPFEngine::insertImaginaryWorker(SortsSimpleTerrain::Loc l)
  {
  ...
  void SortsST_Terrain::SortsPFEngine::removeImaginaryWorker(SortsSimpleTerrain::Loc l)
  {
  ...
  void SortsST_Terrain::SortsPFEngine::removeDynamicObjs() {
  ...
  void SortsST_Terrain::SortsPFEngine::insertDynamicObjs() {
    for (std::set<const Object*>::iterator it = dynamicObjs.begin();
         it != dynamicObjs.end();
         it++) {
      ir_object(*it, true);
  ...
  void SortsST_Terrain::SortsPFEngine::removeControlCenters() {
  ...
  void SortsST_Terrain::SortsPFEngine::insertControlCenters() {
    for (std::set<const Object*>::iterator it = controlCenters.begin();
         it != controlCenters.end();
         it++) {
      ir_object(*it, true);
  ...
  bool SortsST_Terrain::SortsPFEngine::find_path(const Object *obj,
                                       const SortsSimpleTerrain::Loc &goal, 
                                       SortsSimpleTerrain::Path& output)
  {
    SortsSimpleMap<AStarCell> amap(map.get_w(), map.get_h());
  ...
  //-----------------------------------------------------------------------------
  bool SortsST_Terrain::SortsPFEngine::simple_astar(SortsSimpleMap<SizeCell> &smap, SortsSimpleMap<AStarCell> &amap,
    Bucket b, sint4 x2, sint4 y2)
  {
    ...
    while (!open.empty()) {
      ...
      b.set_center(SortsSimpleTerrain::Loc(smap.i2x(he.cell), smap.i2y(he.cell)));
...
//        uint4 newg = he.g + cost[i] + moveCost;
  ...
  */
  void SortsST_Terrain::SortsPFEngine::clear_location(Bucket &b, const SortsSimpleMap<SizeCell> &smap,
    Vector<SortsSimpleTerrain::Loc> &path)
  {
    path.clear();

    SortsSimpleMap<AStarCell> amap(smap.get_w(), smap.get_h());
    sint4 x1 = b.get_center().x;
    sint4 y1 = b.get_center().y;
...
//        uint4 newg = he.g + cost[i] + moveCost;
  ...
  * */
  void SortsST_Terrain::SortsPFEngine::smoothen_path(Vector<SortsSimpleTerrain::Loc> &path)
  {
    uint4 i1 = 0;
    uint4 i2 = 1;
  ...
  //-----------------------------------------------------------------------------
  uint4 SortsST_Terrain::SortsPFEngine::estimate(sint4 x1, sint4 y1, sint4 x2, sint4 y2)
  {
    /*
    *  -----
    *       \   
  ...
  //-----------------------------------------------------------------------------
  bool SortsST_Terrain::SortsPFEngine::on_line(const SortsSimpleTerrain::Loc &a, const SortsSimpleTerrain::Loc &b, const SortsSimpleTerrain::Loc &c)
  {
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::insert_object(const Object *obj)
  {    
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::remove_object(const Object *obj)
  {
    if (((GameObj*)obj)->bp_name() == "controlCenter") {
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::update_object(const Object *obj)
  {
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::insert_boundary(const SortsSimpleTerrain::Segment& l)
  {
    bool costonly;
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::ir_object(const Object *obj, bool insert, bool use_prev_attributes)
  {
    sint4 cost = insert ? 1 : -1;

    if (obj->get_shape() == Object::RECTANGLE) {
      CellFlag f = (insert)? TEMP : OPEN;
      SortsSimpleTerrain::Loc topleft, bottomright;
      Object::ZCat zcat;
      ...
      currently accessible with the new SortsSimpleTerrain interface:
      // one second distance
      Loc head = cworld;
      Loc tail = cworld;
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::init_sizes(SortsSimpleMap<SizeCell> &smap)
  {
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::insert_bucket(const Bucket &b, Object::ZCat zcat, 
    CellFlag f, sint4 x, sint4 cost)
  {
    MapPtr m = (zcat  == Object::ON_LAND)? &map : &air_map;
    sint4 x1, y1;
    const SortsSimpleTerrain::Loc &c = b.get_center();
    const Vector<SortsSimpleTerrain::Loc> &points = b.get_points();
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::insert_rectangle(const Loc &topleft,const Loc &bottomright, 
  ...
  //-----------------------------------------------------------------------------
  void SortsST_Terrain::SortsPFEngine::insert_line(sint4 x1, sint4 y1, sint4 x2, sint4 y2, 
    Object::ZCat zcat,CellFlag f, sint4 x, sint4 cost)
  {
    MapPtr m = (zcat  == Object::ON_LAND)? &map : &air_map;
    int dx = x2-x1;
  ...
  * */
  void SortsST_Terrain::SortsPFEngine::set_cell(MapPtr m, sint4 x, sint4 y,
